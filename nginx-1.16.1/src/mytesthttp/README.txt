...
makedir mytesthttp
pwd: 
/home/work/run_env/hailong/nginx/nginx-1.16.1/src/mytesthttp

work@dev-002:~/run_env/hailong/nginx/nginx-1.16.1/src/mytesthttp$ ls
...
work@dev-002:~/run_env/hailong/nginx/nginx-1.16.1/mytesthttp$ cat ngx_http_mytest_module.c 
...
2. 编译
./configure --prefix=/usr/local/nginx/ --add-module=/home/work/run_env/hailong/nginx/nginx-1.16.1/src/mytesthttp

3. make
更改Makefile，去掉 -Werror
make
make install
...
5. 测试
curl http://192.168.0.3:8027/test
